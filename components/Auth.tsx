    ...
    <div className="h-screen w-screen bg-[#030303] flex flex-col items-center justify-center p-4 md:p-8 overflow-hidden relative">
      ...
      <div className="w-full max-w-md glass-card rounded-[3rem] p-8 md:p-12 border border-[#d4af37]/20 shadow-2xl relative z-10 animate-in fade-in zoom-in duration-700">
        <div className="text-center space-y-4 mb-10">
          <h2 className="text-3xl md:text-4xl font-display font-bold gold-gradient uppercase tracking-tighter">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            <label className="text-[10px] uppercase font-black text-[#d4af37] tracking-[0.4em] ml-2">Identity Token</label>
            <input 
              autoFocus
              required
              placeholder="Username"
              className="w-full bg-black/40 border border-white/10 rounded-2xl p-6 text-white focus:border-[#d4af37] outline-none text-xl font-bold transition-all placeholder:text-white/5"
              value={username}
          ...
          <button 
            type="submit"
            className="w-full py-6 bg-[#d4af37] text-black font-black rounded-2xl uppercase text-xs tracking-[0.4em] transition-all hover:scale-105 active:scale-95 shadow-[0_20px_40px_rgba(212,175,55,0.2)]"
          >
